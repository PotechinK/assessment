...
const questions = [
...

  {
    question: '「情報」とは？',
    correct: '毎日を豊かにする学問',
    incorrect: 'コードエラーに悩まされる学問'
  },
  
  {
    question: 'ダビダビは何を感じながらプログラミングを学んでほしいと言っていた？',
    correct: '楽しさ',
    incorrect: '苦しみ'
  },
  ...
  
  {
    ...
    correct: 'ヴェネツィア',
    incorrect: '東京ディズニーシーのメディテレーニアンハーバー'
  },

  {
    question: 'ダビダビが言ったのは？',
    correct: '大ヒットアプリを開発して一発当てましょう！',
    incorrect: '宝くじを買って一発当てましょう！'
  },
  ...
  {
    question: 'ダビダビが作った格言「夏休みに利確し、ハロウィンまでに戻って来い」は何についていっている？',
    correct: 'S&P500',
    incorrect: 'オルカン'
  },

  {
    ...
    incorrect: '疲れた学生たちに回復魔法「ベホマズン」をかけてくれる'
  },
